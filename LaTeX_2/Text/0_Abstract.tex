...
%Length: For a report this length, around half a page would probably be good. Maximum one page.
    ...
    The memory module consists of a Finite State Machine that acts as a control unit to a clock-independent SRAM. It has a read/write time of less than \SI{3}{ns}, but requires two clock cycles to write, as opposed to a single clock cycle to read.
